...
//
//        //two Task
//        Task task1 = new Task(TaskType.TEST, "Choose something", 777, test );
//        Task task2 = new Task(TaskType.PRACTICAL,"Select cats from table", 8, test, "Select cats from table");
